              ...
              -->
                ...
                :elevation="hover ? 15 : 3">
                    ...
                    <v-row class="pl-3 mt-1 mb-2" v-if="tender.cargo_size !== null && tender.cargo_size !== '' ">
                        ...
                        <p  class=" body-2 primary--text mb-0 mx-3">{{tender.cargo_size}}</p>
                        </v-flex>
                    </v-row>

                    <v-row class="px-3">
                        <p class="body-2  pt-1 ">Delivery timeline :</p>
                        
                        <!-- <v-icon small color="#4169E1" class="px-2 pb-3">
                            arrow_forward
                        </v-icon> -->

                        <p  class="body-2  pt-1 primary--text mx-3">{{tender.customer_delivery_timeline}}</p>
                    </v-row>
