            ...
            <v-flex  xs12 sm4 md4 lg4 xl3 class="py-3 px-2">
                <v-card column width="350"  elevation="3" class="px-4 py-3">
                    ...
                    <v-row row class="px-3">
                        ...
                        <v-spacer></v-spacer>
                        <v-btn small elevation="flat" color="primary white--text" class="">Bid tender</v-btn>
                    </v-row>
                </v-card>
            </v-flex >
            ...
            <v-flex  xs12 sm4 md4 lg4 xl3 class="py-3 px-2">
                <v-card column width="350"  elevation="3" class="px-4 py-3">
                    ...
                    <v-row row class="px-3">
                        <h4  class=" title ">500 USD</h4>
                        <v-spacer></v-spacer>
                        <v-btn small elevation="flat" color="primary white--text" class="">View Details</v-btn>
                    </v-row>
                </v-card>
            </v-flex >
