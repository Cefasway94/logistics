      ...
      <v-card 
        ...
        color="#F5FAFF" >
            ...
            <!-- confirmation dialogues ---------------------------->
              ...
              <template>
                <v-row justify="center" v-if="Agent == 1">
                  <v-dialog
                    v-model="dialog"
                    max-width="350">
                    <v-card>
                      <v-card-title class="headline">You are about to signup as</v-card-title>
            ...
            <!--  -------------------------------------------------->
             ...
             <!-- confirmation dialogues ---------------------------->
              ...
              <template>
                <v-row justify="center" v-if="Transporter == 1">
                  <v-dialog
                    v-model="dialog"
                    max-width="350">
                    <v-card>
            ...
            <!--  -------------------------------------------------->
              ...
              <template>
                <v-row justify="center" v-if="Client == 1">
                  <v-dialog
                    v-model="dialog"
                    max-width="350">
                    <v-card>
